...
int main()
{
    std::string datafile = "/home/nvidia/lyl/yolov3/cfg/coco.data";
    std::string cfgfile = "/home/nvidia/lyl/yolov3/cfg/yolov3.cfg";
    std::string weightfile = "/home/nvidia/lyl/yolov3/yolov3.weights";
